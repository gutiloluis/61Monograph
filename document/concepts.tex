...
In the Gillespie algorithm, we take advantage of the properties of the Poisson process, namely its memorylessness and its merging properties. Assuming all the events are Poissonian, the interarrival times are exponentially distributed and therefore memorylessness \todo[inline]{More detail and rigor} \cite{bertsekas08}.
