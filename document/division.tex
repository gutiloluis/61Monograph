...
\begin{figure}[H]
  ...
  \caption[Noise for partition of molecules in clusters]{\label{fig:div-Pclustering} Noise for partition of molecules in clusters.}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Noise for partition of molecules in clusters 2]{\label{fig:div-Pclustering2}Noise for partition of molecules in clusters 2.}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Volume exclusion]{\label{fig:div-vol_exclusion} Partition of molecules when their volumes are not negligible.}
\end{figure}
...
It can be noticed that noise is more reduced with respect to independent segregation when the volume fraction occupied by each molecule is large. This makes sense because exclusion is stronger if the volumes of the molecules are larger.

\begin{figure}[H]
  \centering
  \includegraphics[width=13cm]{div-Pvol_exclusion}
  \caption[Volume exclusion]{\label{fig:div-Pvol_exclusion} Partition of molecules when their volumes are not negligible.}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Binding to spindle sites]{\label{fig:div-spindles} Partition of molecules when they bind to spindle sites.}
\end{figure}
...
%\begin{figure}[H]
%  \centering
%  \includegraphics[width=13cm]{div-Pspindles}
%  \caption[Noise of binding to spindle sites]{\label{fig:div-Pspindles} Plot of partition of molecules when they bind to spindle sites.}
%\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Pair formation]{\label{fig:div-pair}Pair formation.}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Noise for pair formation]{\label{fig:div-Ppair}Noise for pair formation.}
\end{figure}
