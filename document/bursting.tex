...
\todo[inline]{TODO: Add section in concepts of sum of random variables and convolution?}
...
\todo[inline]{Understand and explain (?) the Bromwich integral}
...
\todo[inline]{Abuse of notation, it is important to difference the rv x from it possible values?}
...
\todo[inline]{TODO: Again, add a section in concepts about sum of random variables and convolution product}
...
\todo[inline]{See if it would be useful to give more detail in the next two steps}
