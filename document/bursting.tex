...
\begin{figure}[H]
  \centering
  \includegraphics[width=15cm]{bur-examples}
...
\footnotetext{The poly(A) tail is an additional stretch of mRNA that is not part of the protein coding sequence. It is important for the processing of mRNA.}
