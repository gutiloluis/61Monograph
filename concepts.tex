...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm]{con-tf_simple}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm]{con-lac_operon}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm]{con-parts_of_DNA}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm]{con-biocircuits_conv}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm]{con-biocircuits_comp}
...
In the Gillespie algorithm, we explode the properties of the Poisson process, namely its memorylessness and its merging properties. Assuming all the events are Poissonian, the interarrival times are exponentially distributed and therefore memorylessness. \cite{bertsekas08} (SAY IT MORE RIGOROUSLY) 
